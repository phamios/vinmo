        ...
        <ScrollView contentContainerStyle={{flex: 1}}>
          <View style={styles.container}>
            <View>
              ...
              <RkText style={styles.title}><RkText style={styles.extraBold}>Vin</RkText>club</RkText>
              <RkText style={styles.subTitle}>Vingroup</RkText>
            ...
            <RkText style={styles.footText}>
              Chào mừng bạn truy cập Vinclub
            </RkText>
          </View>
        </ScrollView>
      </AppWrapper>
