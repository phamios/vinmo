...
import Casts from '../movies/tabs/Casts';
import DefaultTabBar from '../_global/scrollableTabView/DefaultTabBar';
import Info from '../movies/tabs/Info';
import ProgressBar from '../_global/ProgressBar';
import Trailers from '../movies/tabs/Trailers';
import styles from '../movies/styles/Movie';
...
export default connect(mapStateToProps, mapDispatchToProps)(NeedToKnow);
