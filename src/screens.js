...
export function registerScreens(store, Provider) {
	...
	Navigation.registerComponent('movieapp.Group', () => Group, store, Provider);
	Navigation.registerComponent('movieapp.Profile', () => Profile, store, Provider);
	Navigation.registerComponent('movieapp.NeedToKnow', () => NeedToKnow, store, Provider);
